...
//		if (sv_clmovement_buffer.integer && sv_clmovement_buffer_split.integer && host_client->mvbuf_w != host_client->mvbuf_r && host_client->movesequence && host_client->movesequence == host_client->mvbuf[MVBUF_MASK(host_client->mvbuf_r)].sequence)
